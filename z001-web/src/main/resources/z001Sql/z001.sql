-- ----------------------------
-- 创建数据库，参考application-dev.yml配置文件
-- ----------------------------
-- ----------------------------
-- Table structure for z001_header
-- ----------------------------
DROP TABLE IF EXISTS `z001_header`;
CREATE TABLE `z001_header`  (
     ...
     `router_code` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '业务路由',
...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'Z001-抬头' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Table structure for z001_item
-- ----------------------------
DROP TABLE IF EXISTS `z001_item`;
CREATE TABLE `z001_item`  (
...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'Z001-行项目' ROW_FORMAT = DYNAMIC;